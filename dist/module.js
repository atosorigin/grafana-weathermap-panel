...
var limitValueInitialSpace = function limitValueInitialSpace(coorInitialSpace, position, widthBackground, heigthBackground) {
  var result = 0;
  result = parseInt(coorInitialSpace, 10); // if (position === 1 || position === 2) {
  //   //xMin + xMax
 ...
 * @returns {Coor} object edit
 */
var editGoodParameterOrientedLink = function editGoodParameterOrientedLink(name, editCoor, newValue, newValueSelect, widthInitialSpace, heightInitialSpace) {
 ...
 * @returns {Coor} object edit
 */
var editGoodParameterPoint = function editGoodParameterPoint(name, editCoor, newValue, newValueSelect, widthInitialSPaceDefault, heightInitialSPaceDefault //pointIsUpdatedFromEditor: boolean
...
var initOrientedLink = function initOrientedLink(newId, newZIndex) {
  ...
  initMainMetrics, [], false, false, false, initPositionParameter, 'orientedLink' + num.toString(), {
    label: 'Monodirectional',
    value: 'AB'
  }, '9', '0', '0', '#5794F2', '0', '0', '#E54658', '', '', '', '', '', '', zIndex, '0', '0', {}, initMainMetricsB, [], '', '', '', '', '', '', '', '');
...
function (_super) {
  ...
  function SimplePanel(props) {
    ...
    _this.getCoordinatesToDrawPointWithClick = function (event) {
      ...
      var positionX = 0;
      var positionY = 0;
      var paddingMarginLeftSimplePanel = 24; //const spaceFromTop = 207;

      var clickX = event.nativeEvent.clientX - paddingMarginLeftSimplePanel; //const clickY = event.nativeEvent.clientY - spaceFromTop;
      ...
      var heightInitialSpace = yMax - yMin; // if (xMin < 0) {
      ...
      if (yMax > parseInt(_this.props.options.baseMap.height, 10)) {
        //positionY = Math.round(heightInitialSpace - event.nativeEvent.layerY - (yMax - parseInt(this.props.options.baseMap.height, 10)));
        positionY = Math.round(heightInitialSpace - event.nativeEvent.layerY); //positionY = Math.round(heightInitialSpace - event.nativeEvent.layerY);
      } else {
    ...
    _this.createOrientedLinkToClick = function (isIncurved, widthInitialSpace, heightInitialSpace) {
      ...
      var newOrientedLink = new Models_OrientedLinkClass__WEBPACK_IMPORTED_MODULE_5__["OrientedLinkClass"](id, parametrageMetric, '', [], '', initTextObject, {
        ...
        label: 'Monodirectional',
        value: 'AB'
      }, '9', objectIn.x.toString(), objectIn.y.toString(), '#5794F2', objectOut.x.toString(), objectOut.y.toString(), '#E54658', '', '', objectIn.labelPoint, objectOut.labelPoint, objectIn.labelRegion, objectOut.labelRegion, zIndex, pointC.x, pointC.y, isIncurved, {
        key: '',
        unit: '',
        format: '',
        keyValue: '',
        refId: '',
        manageValue: 'avg'
      }, [], widthInitialSpace, heightInitialSpace, objectIn.x.toString(), objectIn.y.toString(), objectOut.x.toString(), objectOut.y.toString(), pointC.x, pointC.y);
  ...
  SimplePanel.prototype.displayPoint = function () {
    ...
    newArrayPoint.forEach(function (line) {
      ...
      var valuesAuxiliaryMetrics = _this.getValuesAuxiliaryMetricsPoint(line); // const ratioX = parseInt(line.positionXDefault, 10) / parseInt(line.widthInitialSpaceDefault, 10);
      ...
      mapItems.push(item); //console.log(this.props.options.loopDisplayPoint);
  ...
  SimplePanel.prototype.displayOrientedLink = function () {
    ...
    arrayOrientedLink.forEach(function (orientedLink) {
      ...
      var valuesAuxiliaryMetricsB = _this.getValuesAuxiliaryMetricsOrientedLinkB(orientedLink); // const ratioXA = parseInt(orientedLink.pointAPositionXDefault, 10) / parseInt(orientedLink.widthInitialSpaceDefault, 10);
      // const ratioYA =
  ...
  SimplePanel.prototype.render = function () {
    ...
    var yMaxMarginTop = yMaxInitialSpace - parseInt(this.props.options.baseMap.height, 10);
...
function (_super) {
  ...
  CoordinateSpace.prototype._handleChange = function (currentTarget, name, index) {
    var tmp = this.state.arrayCoor; // const widthInitialSpaceDefault = (
...
function (_super) {
  ...
  OrientedLink.prototype._handleChange = function (currentTarget, name, index) {
    ...
    var widthInitialSpaceDefault = (parseInt(this.props.options.coordinateSpaceInitial.coordinate.xMax, 10) - parseInt(this.props.options.coordinateSpaceInitial.coordinate.xMin, 10)).toString();
    var heightInitialSpaceDefault = (parseInt(this.props.options.coordinateSpaceInitial.coordinate.yMax, 10) - parseInt(this.props.options.coordinateSpaceInitial.coordinate.yMin, 10)).toString();
    tmp = Object(_Functions_EditParameter_editGoodParameterOrientedLink__WEBPACK_IMPORTED_MODULE_6__["editGoodParameterOrientedLink"])(name, tmp, currentTarget, {}, widthInitialSpaceDefault, heightInitialSpaceDefault);
    this.setState({
      orientedLink: tmp
    });
    this.generateInputsOrientedLink();
...
function (_super) {
  ...
  Point.prototype._handleChange = function (currentTarget, name, index) {
    ...
    var widthInitialSpaceDefault = (parseInt(this.props.options.coordinateSpaceInitial.coordinate.xMax, 10) - parseInt(this.props.options.coordinateSpaceInitial.coordinate.xMin, 10)).toString();
    var heightInitialSpaceDefault = (parseInt(this.props.options.coordinateSpaceInitial.coordinate.yMax, 10) - parseInt(this.props.options.coordinateSpaceInitial.coordinate.yMin, 10)).toString();
    tmp = Object(_Functions_EditParameter_editGoodParameterPoint__WEBPACK_IMPORTED_MODULE_5__["editGoodParameterPoint"])(name, tmp, currentTarget, {}, widthInitialSpaceDefault, heightInitialSpaceDefault);
    this.setState({
      point: tmp
    });
    this.generateInputsPoint();
...
function (_super) {
  ...
  function DrawOrientedLink(props) {
    ...
    _this.defineValueTooptip = function (typeLink, link) {
      ...
      }, contentTooltipAuxMetric), _this.defineHtmlLinkTooltip());
    };
    ...
    _this.defineSizeLink = function () {
      ...
      if (_this.props.size) {
        var size = _this.props.size || ''; // if (size === 'Small') {
        //   result = '8';
        // } else if (size === 'Medium') {
        //   result = '9';
        // } else if (size === 'Large') {
  ...
  DrawOrientedLink.prototype.synchroLinkX = function (positionX, name) {
    var _this = this; //console.log(positionX);
    ...
    var xMax = parseInt(initialSpace.xMax, 10);
    var widthInitialSpace = xMax - xMin;
    var ratioX = positionX / parseInt(this.props.widthInitialSpaceDefault, 10);
    var x = Math.round(this.defineLimitX(xMin + widthInitialSpace * ratioX));
    ...
    this.props.options.arrayOrientedLinks = newArrayLink; // if (!defaultReferentiel) {
    //   if (xMin < 0 && xMax < 0) {
  ...
  DrawOrientedLink.prototype.synchroLinkY = function (positionY, name) {
    ...
    var heightInitialSpace = yMax - yMin;
    var ratioY = (parseInt(this.props.heightInitialSpaceDefault, 10) - positionY) / parseInt(this.props.heightInitialSpaceDefault, 10);
    var y = Math.round(this.defineLimitY(this.props.heightImage - yMax + heightInitialSpace * ratioY));
    var newArrayLink = this.props.options.arrayOrientedLinks;
    newArrayLink.forEach(function (link) {
      if (link.name === _this.props.name) {
        if (name === 'yA') {
          link.pointAPositionY = (_this.props.heightImage - y).toString();
        } else if (name === 'yB') {
          link.pointBPositionY = (_this.props.heightImage - y).toString();
        } else if (name === 'yC') {
          link.pointCPositionY = (_this.props.heightImage - y).toString();
        }
      }
    });
    this.props.options.arrayOrientedLinks = newArrayLink; // if (!defaultReferentiel) {
  ...
  DrawOrientedLink.prototype.defineColorLink = function (link) {
    var _this = this;
...
function (_super) {
  ...
  DrawPoint.prototype.definePositionX = function (positionX, initialSpace, size, shape) {
    var _this = this; // console.log('x avant');
    ...
    var xMax = parseInt(initialSpace.xMax, 10);
    var widthInitialSpace = xMax - xMin;
    var ratioX = parseInt(this.props.positionXDefault, 10) / parseInt(this.props.widthInitialSpaceDefault, 10); //let x = this.defineLimitX(xMin + widthInitialSpace * ratioX) - (size + parseInt(this.defineBorderSize(), 10));

    var x = Math.round(this.defineLimitX(xMin + widthInitialSpace * ratioX) - (size + parseInt(this.defineBorderSize(), 10))); // console.log(xMin);
    ...
    this.props.options.arrayPoints = newArrayPoint; // if (!defaultReferentiel) {
  ...
  DrawPoint.prototype.definePositionY = function (positionY, initialSpace, size, shapeGraphicMarker) {
    ...
    var yMax = parseInt(initialSpace.yMax, 10);
    var heightInitialSpace = yMax - yMin;
    var ratioY = (parseInt(this.props.heightInitialSpaceDefault, 10) - parseInt(this.props.positionYDefault, 10)) / parseInt(this.props.heightInitialSpaceDefault, 10);
    var y = Math.round(this.defineLimitY(this.props.heightImage - yMax + heightInitialSpace * ratioY) - (size + parseInt(this.defineBorderSize(), 10)));
    var newArrayPoint = this.props.options.arrayPoints;
    newArrayPoint.forEach(function (point) {
      if (point.name === _this.props.name) {
        point.positionShapeY = (_this.props.heightImage - y).toString();
      }
    });
    this.props.options.arrayPoints = newArrayPoint; // let y = parseInt(this.props.options.baseMap.height, 10) - yMaxInitialSpace + heightInitialSpace * ratioY;
    // let yMinPx = 0;
    // let yMaxPx = 0;
    // if (!defaultReferentiel) {
    //   if (yMin < 0 && yMax < 0) {
  ...
  DrawPoint.prototype.defineContentTooltip = function (localisation) {
    ...
    }, contentTooltipAuxMetric), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, contentTooltipAssociateLink), this.defineHtmlLinkTooltip()));
  };
...
function (_super) {
  ...
  function DrawRectangleExtend(props) {
    ...
    _this.getCoordinatePxAdaptToInitialSpace = function (region, coorRegion, coorRegionDefault, widthInitialSpaceDefault, heightInitialSpaceDefault) {
      ...
      rightPx = Math.round(_this.defineLimitX(widthInitialSpace * ratioRight + (widthInitialSpaceDefault - xMax)));
      topPx = Math.round(_this.defineLimitY(heightInitialSpace * ratioTop + (heightInitialSpaceDefault - yMax)));
...
function (_super) {
  ...
  function FixColor(props) {
    ...
    _this.addButtonColor = function () {
      ...
      if (_this.props.isLink && _this.props.traceBack) {
        var keyContourDiv = key + 'ContourDiv';
        couleur.push(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
          key: keyContourDiv
...
/* harmony import */ var Models_RegionClass__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! Models/RegionClass */ "./Models/RegionClass.tsx");
/* harmony import */ var Functions_initRegionCoordinateSpace__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! Functions/initRegionCoordinateSpace */ "./Functions/initRegionCoordinateSpace.tsx");
...
function (_super) {
  ...
  function Gabarit(props) {
    ...
    _this.fillGlobalGabaritDefault = function (file) {
      var defaultValue = {
    ...
    _this.loadDefaultGabarit = function (file, url) {
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
        var name, newGabarit, regions, points, links, defaultValue, _a, _b, region, file_1, response, error_2, e_1_1, _c, _d, point, file_2, response, error_3, e_2_1, _e, _f, link, file_3, response, error_4, e_3_1;
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_k) {
          switch (_k.label) {
            case 0:
              ...
              points = [];
              links = [];
              defaultValue = this.fillGlobalGabaritDefault(file);
              console.log(defaultValue);
              _k.label = 1;

            case 1:
              _k.trys.push([1, 9, 10, 11]);

              _a = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(file.templates.regions), _b = _a.next();
              _k.label = 2;
            ...
            case 11:
              ...
              _c = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(file.templates.points), _d = _c.next();
              _k.label = 12;
            ...
            case 21:
              _k.trys.push([21, 29, 30, 31]);

              _e = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(file.templates.links), _f = _e.next();
              _k.label = 22;
    ...
    _this.fillRegionDefault = function (uneRegion, defaultValue, id) {
      var newRegion = Object(Functions_initRegionCoordinateSpace__WEBPACK_IMPORTED_MODULE_10__["initRegionCoordinateSpace"])(id);
      console.log(newRegion);
      newRegion.linkURL = uneRegion.linkURL ? uneRegion.linkURL : defaultValue.linkURL;
      newRegion.label = uneRegion.label; // fill region with uneRegion and if value is undefined and if exist in GlobalGabaritDefault -> add value
    };

    _this.fillPointDefault = function (unPoint, defaultValue) {
      console.log(unPoint);
    };

    _this.fillLinkDefault = function (unLink, defaultValue) {
      console.log(unLink);
    };

    _this.fetchDataGabaritDefault = function (defaultValue, regions, points, links) {
      // regions
      ...
      try {
        for (var _h = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(_this.props.options.regionCoordinateSpace), _j = _h.next(); !_j.done; _j = _h.next()) {
          var line = _j.value;
      ...
      try {
        for (var regions_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(regions), regions_1_1 = regions_1.next(); !regions_1_1.done; regions_1_1 = regions_1.next()) {
          var line = regions_1_1.value;

          try {
            for (var _k = (e_6 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(line.regions)), _l = _k.next(); !_l.done; _l = _k.next()) {
              var uneRegion = _l.value;

              _this.fillRegionDefault(uneRegion, defaultValue, id);
      ...
      try {
        ...
        for (var points_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(points), points_1_1 = points_1.next(); !points_1_1.done; points_1_1 = points_1.next()) {
          ...
          try {
            for (var _m = (e_8 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(line.points)), _o = _m.next(); !_o.done; _o = _m.next()) {
              var unPoint = _o.value;

              _this.fillPointDefault(unPoint, defaultValue);
            }
          } catch (e_8_1) {
            e_8 = {
              error: e_8_1
      ...
      try {
        ...
        for (var links_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(links), links_1_1 = links_1.next(); !links_1_1.done; links_1_1 = links_1.next()) {
          var line = links_1_1.value;

          try {
            for (var _p = (e_10 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(line.links)), _q = _p.next(); !_q.done; _q = _p.next()) {
              var unLink = _q.value;

              _this.fillLinkDefault(unLink, defaultValue);
            }
          } catch (e_10_1) {
            e_10 = {
              error: e_10_1
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              url = this.state.gabaritDefaultUrlInput;
              file = {};
              return [4
              /*yield*/
              , fetch(this.state.gabaritDefaultUrlInput)];
    ...
    _this.loaderGabarit = function (gab, idx) {
      ...
      var generateValue;
      var generateAux;
      var initialWidth = parseInt(_this.props.options.coordinateSpaceInitial.coordinate.xMax, 10) - parseInt(_this.props.options.coordinateSpaceInitial.coordinate.xMin, 10);
      var initialHeight = parseInt(_this.props.options.coordinateSpaceInitial.coordinate.yMax, 10) - parseInt(_this.props.options.coordinateSpaceInitial.coordinate.yMin, 10);
      /* Region */
      //Template
      ...
      if (labelCoord.length > 0) {
        ...
        filterPoint.forEach(function (element, index) {
          if (metricPoint.length > 0) {
            var toLoad = new Models_PointClass__WEBPACK_IMPORTED_MODULE_7__["PointClass"](newID + 1, linkURLPoint[index], metaPoint[index], gabaritFileTmp.globalGabarit.lowerLimit, labelPoint[index] + newID, textObj, mainMetricPoint[index], metricPoint[index], colorMode, traceBack, traceBorder, positionParameterPoint[index], namePoint[index] + newID, valueMetricPoint[index], drawGraphicMarkerPoint[index], shapePoint[index], sizeWidthPoint[index], sizeHeightPoint[index], '', posPoint[index].x, posPoint[index].y, colorPoint[index], associateOrientedLinksInPoint[index], associateOrientedLinksOutPoint[index], initialWidth.toString(), initialHeight.toString(), posPoint[index].x, posPoint[index].y);
            newID++;
      ...
      filterLink.forEach(function (element, index) {
        ...
        if (!(maA > 0) && maB > 0) {
          ...
          var toLoad = new Models_OrientedLinkClass__WEBPACK_IMPORTED_MODULE_4__["OrientedLinkClass"](newID + 1, linkURLLink[index], metaLink[index], gabaritFileTmp.globalGabarit.lowerLimit, labelLink[index], textObj, mainMetricALink[index], [], colorMode, traceBack, traceBorder, positionParameterLink[index], nameLink[index], orientationLink[index], sizeLink[index], posALink[index].x, posALink[index].y, colorALink[index], posBLink[index].x, posBLink[index].y, colorBLink[index], valueMetricALink[index], valueMetricBLink[index], pointInLink[index], pointOutLink[index], regionInLink[index], regionOutLink[index], 1, /// à revoir
          posCLink[index].x, posCLink[index].y, isIncurvedLink[index], mainMetricBLink[index], [], widthInitialSpaceDefault, heightInitialSpaceDefault, posALink[index].x, posALink[index].y, posBLink[index].x, posBLink[index].y, posCLink[index].x, posCLink[index].y);
          newID++; //console.log(toLoad);
      ...
      gabaritFileTmp.templateGabaritRegion.forEach(function (region, index) {
        ...
        var regionPush = new Models_RegionClass__WEBPACK_IMPORTED_MODULE_9__["RegionClass"](id, linkURLRegion[0], metaRegion[0], gabaritFileTmp.globalGabarit.lowerLimit, labelRegion[0], textObj, mainMetricRR, [], colorMode, traceBack, traceBorder, positionParameterRegion[0], idSVGRegion[0], [], coor, coor, modeRegion[0], imgRegion[0], '', '');
        console.log(regionPush);
        var newRegion = _this.props.options.regionCoordinateSpace;
      ...
      if (idx) {
        _this.props.options.saveGabaritFile[idx].loaded = true;
      }
    };
    ...
    _this.delAll = function () {
      ...
      _this.props.options.saveGabaritURL = [];
      _this.props.options.saveGabaritURL = []; // this.props.options.saveGabaritURL.mono = [];
  ...
  Gabarit.prototype.render = function () {
    ...
    }, "Add")), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Collapse"], {
