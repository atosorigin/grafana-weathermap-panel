...
/* harmony import */ var _Parametrage_styleComponent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../Parametrage/styleComponent */ "./components/Parametrage/styleComponent.tsx");
...
function (_super) {
  ...
  function ManageMetadata(props) {
    var _this = _super.call(this, props) || this; // update input


    _this.setPromiseMeta = function (state) {
      return new Promise(function (resolve) {
        _this.setState(state, resolve);
      });
    };

    _this._handleChange = function (str, index) {
      var old = _this.state.meta;
      old[index].meta = str;
    ...
    _this.onChangeColorBack = function (key, color) {
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
        var old;
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
          old = this.state.meta;
    ...
    _this.onChangeSwitch = function (key) {
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
        var old;
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
          old = this.state.meta;
    ...
    _this.saveStyleData = function (style, key) {
      var old = _this.state.meta;
    ...
    _this.deleteMeta = function (index) {
      var old = _this.state.meta;
      old.splice(index, 1);
    ...
    _this.addElement = function (index) {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        key: 'keyMeta' + index
        ...
        value: _this.state.meta[index].meta,
        labelWidth: 15,
        inputWidth: 15,
        type: "text",
        onChange: function onChange(event) {
          return _this._handleChange(event.currentTarget.value, index);
        }
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Switch"], {
        label: "Display test in tooltip",
        checked: _this.state.meta[index].obj.isTooltip,
        onChange: function onChange() {
          return _this.onChangeSwitch(index);
        }
        ...
        color: _this.state.meta[index].obj.colorBack,
        keyInt: index,
        text: "Color back",
        _onChange: _this.onChangeColorBack
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Functions_Input_inputSeriesColorPicker__WEBPACK_IMPORTED_MODULE_4__["default"], {
        color: _this.state.meta[index].obj.colorText,
        keyInt: index,
        text: "Color text",
        _onChange: _this.onChangeColorText
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_Parametrage_styleComponent__WEBPACK_IMPORTED_MODULE_5__["default"], {
        oldStyle: _this.state.meta[index].obj.style,
        saveParent: function saveParent(style) {
          return _this.saveStyleData(style, index);
        }
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        variant: "danger",
        className: "button",
        onClick: function onClick() {
          return _this.deleteMeta(index);
        }
      }, "Delete"));
    }; // init all input and call this function for refresh data (after onChange)


    _this.initArrayTag = function () {
      var i = 0;
      var sizeMeta = _this.state.meta.length;
      var _final = [];

      while (i < sizeMeta) {
        _final.push(_this.addElement(i));

        ++i;
      }

      var test = react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("ul", null, _final);

      _this.setState({
        upline: react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("ul", null, test),
        arrayMeta: _final,
        index: i
      });

      _this.props.saveToParent(_this.state.meta);
    }; // init new meta


    _this.createNewMeta = function (newElement) {
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
        var old;
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
          switch (_a.label) {
    ...
    _this.addElementArray = function (newElement) {
      _this.createNewMeta(newElement);
    ...
    _this.state = {
      ...
      arrayMeta: [],
      index: 0,
      upline: react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null),
  ...
  ManageMetadata.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Collapse"], {
      ...
      className: "button",
      onClick: function onClick() {
        return _this.addElementArray(_this.state.newMeta);
      }
    }, "Add"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, this.state.upline)));
  };
...
function (_super) {
  ...
  DrawPoint.prototype.defineContentTooltip = function (localisation) {
    ...
    if (arrayOrientedLinksOut.length !== 0) {
      ...
      arrayOrientedLinksOut.forEach(function (orientedLinkOut) {
        ...
        contentTooltipAssociateLink.push(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", {
          ...
          style: styleContentAssociateLink
        }, "- ", nameOrientedLink)); // console.log(nameOrientedLink);
      });
    }
    ...
    }, contentTooltipAuxMetric), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, contentTooltipAssociateLink), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      style: {
        backgroundColor: addBackColorMainMetric ? backColorMainMetric : backColoTextObject,
        padding: '0 5px'
      }
    }, contentTooltipMetadata), this.defineHtmlLinkTooltip()));
  };
...
function (_super) {
  ...
  function DrawRectangleExtend(props) {
    ...
    _this.setStateTooltip = function (lowerLimit, region, valueQuery //link: boolean
      ...
      var tooltipValue = valueQueryResult !== '' ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        style: styleTooltip
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", {
  ...
  function Gabarit(props) {
    ...
    _this.loaderGabarit = function (gab, idx) {
      ...
      gabaritFileTmp.templateGabaritPoint.forEach(function (point, index) {
        ...
        if (!metaPoint[index]) {
          metaPoint[index] = _this.props.options.gabaritDefault.templateGabaritPointDefault[0].meta;
        }
      ...
      labelCoord.forEach(function (labelCo) {
        var e_2, _a;
        ...
        if (labelCo.length > 0) {
          var _loop_1 = function _loop_1(pos) {
            filterPoint.forEach(function (element, index) {
              ...
              if (metricPoint.length > 0) {
                ...
                if (_this.checkCoordinateFilterPoint(toLoad, _this.props)) {
                  newID++;
                }
              } else {
          ...
          filterPoint.forEach(function (element, index) {
            var defaultPositionX = ((parseInt(posPoint[index].x, 10) - xMinInitialSpace) / widthInitialSpace * widthBackground).toString();
            var defaultPositionY = ((parseInt(posPoint[index].y, 10) - yMinInitialSpace) / heightInitialSpace * heightBackground).toString();

            if (metricPoint.length > 0) {
              var toLoad = new Models_PointClass__WEBPACK_IMPORTED_MODULE_8__["PointClass"](newID + 1, linkURLPoint[index], // changement
              // metaPoint[index],
              [], gabaritFileTmp.globalGabarit.lowerLimit, labelPoint[index] + '_' + newID, textObj, mainMetricPoint[index], metricPoint[index], colorMode, traceBack, traceBorder, positionParameterPoint[index], namePoint[index] + '_' + newID, valueMetricPoint[index], drawGraphicMarkerPoint[index], shapePoint[index], sizeWidthPoint[index], sizeHeightPoint[index], '', posPoint[index].x, posPoint[index].y, colorPoint[index], associateOrientedLinksInPoint[index], associateOrientedLinksOutPoint[index], widthInitialSpace.toString(), heightInitialSpace.toString(), defaultPositionX, defaultPositionY);
              ...
              var toLoad = new Models_PointClass__WEBPACK_IMPORTED_MODULE_8__["PointClass"](newID + 1, linkURLPoint[index], // changement
              [], gabaritFileTmp.globalGabarit.lowerLimit, labelPoint[index] + '_' + newID, textObj, mainMetricPoint[index], [], colorMode, traceBack, traceBorder, positionParameterPoint[index], namePoint[index] + '_' + newID, valueMetricPoint[index], drawGraphicMarkerPoint[index], shapePoint[index], sizeWidthPoint[index], sizeHeightPoint[index], '', posPoint[index].x, posPoint[index].y, colorPoint[index], associateOrientedLinksInPoint[index], associateOrientedLinksOutPoint[index], widthInitialSpace.toString(), heightInitialSpace.toString(), defaultPositionX, defaultPositionY);
      ...
      gabaritFileTmp.templateGabaritLink.forEach(function (link, index) {
        ...
        if (!metaLink[index]) {
          // changement
          _this.props.options.gabaritDefault.templateGabaritLinkDefault[0].meta;
        }
            ...
            if (element.refId === mainMetricBLink[index].refId) {
              ...
              try {
                for (var nameQuery_3 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(nameQuery), nameQuery_3_1 = nameQuery_3.next(); !nameQuery_3_1.done; nameQuery_3_1 = nameQuery_3.next()) {
                  var oneQuery = nameQuery_3_1.value;
        ...
        if (gabaritFileTmp.templateGabaritLink[index].labelfix.toString() === 'false') {
          _this.props.data.series.forEach(function (element) {
            ...
            try {
              ...
              try {
                if (nameQuery_4_1 && !nameQuery_4_1.done && (_a = nameQuery_4["return"])) _a.call(nameQuery_4);
              } finally {
                if (e_5) throw e_5.error;
              }
            }
        ...
        if (element.length > 0) {
          var _loop_2 = function _loop_2(pos) {
            filterLink.forEach(function (element, index) {
              ...
              if (maA > 0 && maB > 0) {
                var toLoad = new Models_OrientedLinkClass__WEBPACK_IMPORTED_MODULE_4__["OrientedLinkClass"](newID + 1, linkURLLink[index], [], gabaritFileTmp.globalGabarit.lowerLimit, labelLink[index] + '_' + newID, textObj, _this.addFilterDynamic(mainMetricALink[index], posALink[index], pos), metricALink[index], colorMode, traceBack, traceBorder, positionParameterLink[index], nameLink[index], orientationLink[index], sizeLink[index], pos.x, pos.y, colorALink[index], labelCoordB[coordindex][index].x, labelCoordB[coordindex][index].y, colorBLink[index], valueMetricALink[index], valueMetricBLink[index], pointInLink[index], pointOutLink[index], regionInLink[index], regionOutLink[index], _this.props.options.zIndexOrientedLink + 1, labelCoordC[coordindex][index].x, labelCoordC[coordindex][index].y, isIncurvedLink[index], _this.addFilterDynamic(mainMetricBLink[index], posALink[index], pos), metricBLink[index], widthInitialSpace.toString(), heightInitialSpace.toString(), defaultPositionAX, defaultPositionAY, defaultPositionBX, defaultPositionBY, defaultPositionCX, defaultPositionCY);

                if (_this.checkCoordinateFilterLink(toLoad, _this.props)) {
                  newID++;
                }
              }

              if (!(maA > 0) && maB > 0) {
                var toLoad = new Models_OrientedLinkClass__WEBPACK_IMPORTED_MODULE_4__["OrientedLinkClass"](newID + 1, linkURLLink[index], [], gabaritFileTmp.globalGabarit.lowerLimit, labelLink[index] + '_' + newID, textObj, _this.addFilterDynamic(mainMetricALink[index], posALink[index], pos), [], colorMode, traceBack, traceBorder, positionParameterLink[index], nameLink[index], orientationLink[index], sizeLink[index], pos.x, pos.y, colorALink[index], labelCoordB[coordindex][index].x, labelCoordB[coordindex][index].y, colorBLink[index], valueMetricALink[index], valueMetricBLink[index], pointInLink[index], pointOutLink[index], regionInLink[index], regionOutLink[index], _this.props.options.zIndexOrientedLink + 1, labelCoordC[coordindex][index].x, labelCoordC[coordindex][index].y, isIncurvedLink[index], _this.addFilterDynamic(mainMetricBLink[index], posALink[index], pos), metricBLink[index], widthInitialSpace.toString(), heightInitialSpace.toString(), defaultPositionAX, defaultPositionAY, defaultPositionBX, defaultPositionBY, defaultPositionCX, defaultPositionCY);
          ...
          filterLink.forEach(function (element, index) {
            var defaultPositionAX = ((parseInt(posALink[index].x, 10) - xMinInitialSpace) / widthInitialSpace * widthBackground).toString();
            var defaultPositionBX = ((parseInt(posBLink[index].x, 10) - xMinInitialSpace) / widthInitialSpace * widthBackground).toString();
            var defaultPositionCX = ((parseInt(posCLink[index].x, 10) - xMinInitialSpace) / widthInitialSpace * widthBackground).toString();
            var defaultPositionAY = ((parseInt(posALink[index].y, 10) - yMinInitialSpace) / heightInitialSpace * heightBackground).toString();
            var defaultPositionBY = ((parseInt(posBLink[index].y, 10) - yMinInitialSpace) / heightInitialSpace * heightBackground).toString();
            var defaultPositionCY = ((parseInt(posCLink[index].y, 10) - yMinInitialSpace) / heightInitialSpace * heightBackground).toString();
            var maA = metricALink.length;
            var maB = metricBLink.length;

            if (maA > 0 && maB > 0) {
              var toLoad = new Models_OrientedLinkClass__WEBPACK_IMPORTED_MODULE_4__["OrientedLinkClass"](newID + 1, linkURLLink[index], [], gabaritFileTmp.globalGabarit.lowerLimit, labelLink[index] + '_' + newID, textObj, mainMetricALink[index], metricALink[index], colorMode, traceBack, traceBorder, positionParameterLink[index], nameLink[index], orientationLink[index], sizeLink[index], posALink[index].x, posALink[index].y, colorALink[index], posBLink[index].x, posBLink[index].y, colorBLink[index], valueMetricALink[index], valueMetricBLink[index], pointInLink[index], pointOutLink[index], regionInLink[index], regionOutLink[index], _this.props.options.zIndexOrientedLink + 1, posCLink[index].x, posCLink[index].y, isIncurvedLink[index], mainMetricBLink[index], metricBLink[index], widthInitialSpace.toString(), heightInitialSpace.toString(), defaultPositionAX, defaultPositionAY, defaultPositionBX, defaultPositionBY, defaultPositionCX, defaultPositionCY);
            ...
            if (!(maA > 0) && maB > 0) {
              ...
              var toLoad = new Models_OrientedLinkClass__WEBPACK_IMPORTED_MODULE_4__["OrientedLinkClass"](newID + 1, linkURLLink[index], [], gabaritFileTmp.globalGabarit.lowerLimit, labelLink[index] + '_' + newID, textObj, mainMetricALink[index], metricALink[index], colorMode, traceBack, traceBorder, positionParameterLink[index], nameLink[index], orientationLink[index], sizeLink[index], posALink[index].x, posALink[index].y, colorALink[index], posBLink[index].x, posBLink[index].y, colorBLink[index], valueMetricALink[index], valueMetricBLink[index], pointInLink[index], pointOutLink[index], regionInLink[index], regionOutLink[index], _this.props.options.zIndexOrientedLink + 1, posCLink[index].x, posCLink[index].y, isIncurvedLink[index], mainMetricBLink[index], [], widthInitialSpace.toString(), heightInitialSpace.toString(), defaultPositionAX, defaultPositionAY, defaultPositionBX, defaultPositionBY, defaultPositionCX, defaultPositionCY);
      ...
      gabaritFileTmp.templateGabaritRegion.forEach(function (region, index) {
        ...
        if (!metaRegion[index]) {
          ...
          _this.props.options.gabaritDefault.templateGabaritRegionDefault[0].meta;
        }
      ...
      filterRegion.forEach(function (element, index) {
        if (metricRegion.length > 0) {
          var toLoad = new Models_RegionClass__WEBPACK_IMPORTED_MODULE_10__["RegionClass"](newID + 1, linkURLRegion[index], [], gabaritFileTmp.globalGabarit.lowerLimit, labelRegion[index] + '_' + newID, textObj, mainMetricRegion[index], metricRegion[index], colorMode, traceBack, traceBorder, positionParameterRegion[index], idSVGRegion[index], orientedLinkAssociate[index], posRegion[index], posRegion[index], modeRegion[index], imgRegion[index], widthInitialSpace.toString(), heightInitialSpace.toString());
          newID++;

          _this.props.options.regionCoordinateSpace.push(toLoad);
        } else {
          var toLoad = new Models_RegionClass__WEBPACK_IMPORTED_MODULE_10__["RegionClass"](newID + 1, linkURLRegion[index], [], gabaritFileTmp.globalGabarit.lowerLimit, labelRegion[index] + '_' + newID, textObj, mainMetricRegion[index], [], colorMode, traceBack, traceBorder, positionParameterRegion[index], idSVGRegion[index], orientedLinkAssociate[index], posRegion[index], posRegion[index], modeRegion[index], imgRegion[index], widthInitialSpace.toString(), heightInitialSpace.toString());
          newID++;
