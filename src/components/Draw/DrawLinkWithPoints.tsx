...
export default class DrawLienWithPoints extends React.Component<IProps, IState> {
	...
	public defineXRegionOfPointIn(): number {
	...
	public defineYRegionOfPointIn(): number {
	...
	public defineXRegionOfPointOut(): number {
	...
	public defineYRegionOfPointOut(): number {
	...
	public drawLink(xA: number, xB: number, yA: number, yB: number, colorA: string, colorB: string,
		orientationLink: string, labelA: string, labelB: string, labelAPositionX: number,
		labelAPositionY: number, labelBPositionX: number, labelBPositionY: number) {
