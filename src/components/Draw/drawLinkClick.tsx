...
export default class DrawLinkClick extends React.Component<Props, State> {
  ...
  private drawLink(xA: number, yA: number, xB: number, yB: number, colorA: string, colorB: string, labelA: string, labelB: string) {
  ...
  render() {
    ...
    return <div>{this.drawLink(xA, yA, xB, yB, colorA, colorB, labelA, labelB)}</div>;
  }
}
