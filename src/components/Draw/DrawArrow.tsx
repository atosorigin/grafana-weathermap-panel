...
export default class DrawArrow extends React.Component<IProps, IState> {
	...
	public defineCenterX(coordinateSpace: SelectableValue<EspaceCoordonneesClass>): number {
		let result: number = 0;
		result = this.props.height / 2;
		return result;
	}

	public defineCenterY(coordinateSpace: SelectableValue<EspaceCoordonneesClass>): number {
		let result: number = 0;
		result = this.props.height / 2;
		return result;
	}
