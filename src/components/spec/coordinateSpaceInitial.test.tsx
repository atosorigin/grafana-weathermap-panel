...
describe('CoordinatSpaceInitial tests', () => {
  ...
  //     expect(component.state.arrayCoor.coordinate.xMin).toBe('0');
  //   });
  ...
  //     component._handleChange(currentTarget, name);
  //     expect(spy).toHaveBeenCalled();
  //     expect(component.state.arrayCoor.coordinate.xMax).toBe('100');
  //   });
  //   test('_handleChange xMax', async () => {
  //     let currentTarget = '0';
  ...
  //     component._handleChange(currentTarget, name);
  //     expect(spy).toHaveBeenCalled();
  //     expect(component.state.arrayCoor.coordinate.yMin).toBe('0');
  //   });
  ...
  //     component._handleChange(currentTarget, name);
  //     expect(spy).toHaveBeenCalled();
  //     expect(component.state.arrayCoor.coordinate.yMax).toBe('100');
  //   });
  // });
