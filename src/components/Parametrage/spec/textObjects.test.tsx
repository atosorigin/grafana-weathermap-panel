...
//   test('test onSwitchdisplayObjectInTooltip', () => {
//     component.onSwitchdisplayObjectInTooltip();

//     expect(component.state.textObject.displayObjectInTooltip).toBe(true);
//     component.onSwitchdisplayObjectInTooltip();

//     expect(component.state.textObject.displayObjectInTooltip).toBe(false);
//   });
