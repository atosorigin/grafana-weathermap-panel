...
import { defaults, SimpleOptions, ITarget } from '../../../types';
...
describe('TextObjects tests', () => {
	...
	beforeEach(() => {
		...
		testTextObject = new TextObject('legend', 'value', 'unit', 'colbr', 'coltxtr', 'ctyletxtr', 'colbackbu', 'coltxtbu', 'styletxtby', false, 'legelement', 'numformatel', 'unitumseu', false, false, false, 'coltxtele', false, 'colbackel');
