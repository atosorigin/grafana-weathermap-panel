...
export const cloneRegionCoordinateSpace = (region: RegionClass): RegionClass => {
	...
	const newCoordinate: RegionClass = new RegionClass(
		region.id, linkURL, region.meta, region.lowerLimit,
		region.label, initTextObject,
		mainMetric,
		region.metrics,
		region.colorMode, region.traceBack, region.traceBorder,
		positionParameter, region.idSVG,
		region.orientedLink, coords, region.mode, region.img);
	return newCoordinate;
};