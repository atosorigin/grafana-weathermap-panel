...
describe('Display tests', () => {
  ...
  let propsAB: any = {
    ...
    data: {
          ...
          fields: [
            ...
            },
            {
              ...
              values: [
                ...
                0.09472210606694144,
                0.07834654257252864,
                0.059807307762225426,
                0.05545454545454566,
                0.0409090909090909,
                0.049455444644447545,
                0.05163542481045754,
                0.05145828787548156,
                0.07854117048160997,
                0.10527272727272764,
      ...
      request: {
        ...
        panelId: 2,
        dashboardId: 9,
        range: { from: '2020-04-09T11:56:15.259Z', to: '2020-04-09T12:01:15.260Z', raw: { from: 'now-5m', to: 'now' } },
        timeInfo: '',
        interval: '15s',
        intervalMs: 15000,
        targets: [
        ...
        maxDataPoints: 1856,
        scopedVars: { __interval: { text: '15s', value: '15s' }, __interval_ms: { text: '15000', value: 15000 } },
        startTime: 1586433675260,
        rangeRaw: { from: 'now-5m', to: 'now' },
        endTime: 1586433675322,
      },
      timeRange: { from: '2020-04-09T11:56:15.322Z', to: '2020-04-09T12:01:15.323Z', raw: { from: 'now-5m', to: 'now' } },
      timings: { dataProcessingTime: 1 },
    },
  };
  ...
  let regionClass: RegionClass = new RegionClass(
    regionCoods.id,
    regionCoods.linkURL,
    regionCoods.meta,
  ...
  let orientedLinkClass: OrientedLinkClass = new OrientedLinkClass(
    link.id,
    link.linkURL,
    link.meta,
    link.lowerLimit,
  ...
  describe('reqMetricAuxRegion', () => {
    test('Have to fill the returnQuery', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(regionClass.metrics[1].returnQuery).toEqual(result);
        done();
      });
    });
    test('Empty returnQuery', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(regionClass.metrics[1].returnQuery).toEqual([]);
        done();
      });
    });
  });
  ...
  describe('reqMetricAuxPoint', () => {
    test('Have to fill the returnQuery', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(pointClass.metrics[1].returnQuery).toEqual(result);
        done();
      });
    });
    test('Empty returnQuery', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(pointClass.metrics[1].returnQuery).toEqual([]);
        done();
      });
    });
  });
  ...
  describe('reqMetricAuxLink', () => {
    test('Have to fill the returnQuery', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(orientedLinkClass.metrics[1].returnQuery).toEqual(result);
        done();
      });
    });
    test('Empty returnQuery', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(orientedLinkClass.metrics[1].returnQuery).toEqual([]);
        done();
      });
    });
  });
  // describe('reqMetricOrientedLink', () => {
  //   test('Have to fill the returnQuery', (done) => {
  //     reqMetricOrientedLink(orientedLinkClass, props);
  //     setTimeout(() => {
  ...
  //   });
  // });
  // describe('reqMetricAuxOrientedLink', () => {
  //   test('Have to fill the returnQuery', (done) => {
  //     reqMetricAuxOrientedLink(orientedLinkClass, props);
  //     setTimeout(() => {
  //       //expect(result).toStrictEqual(expected);
  //       done();
  //     });
  ...
  describe('reqUpdateMetrics', () => {
    test('Empty returnQuery', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(propsA.options.regionCoordinateSpace[0].metrics[0].returnQuery).toEqual([]);
        expect(propsA.options.regionCoordinateSpace[0].metrics[1].returnQuery).toEqual([]);
        expect(propsA.options.arrayPoints[0].mainMetric.returnQuery).toStrictEqual([]);
        expect(propsA.options.arrayPoints[0].metrics[0].returnQuery).toEqual([]);
        expect(propsA.options.arrayPoints[0].metrics[1].returnQuery).toEqual([]);
        expect(propsA.options.arrayOrientedLinks[0].mainMetric.returnQuery).toStrictEqual([]);
        expect(propsA.options.arrayOrientedLinks[0].metrics[0].returnQuery).toEqual([]);
        expect(propsA.options.arrayOrientedLinks[0].metrics[1].returnQuery).toEqual([]);
        done();
      });
    });
  });
