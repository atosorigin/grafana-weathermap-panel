...
export const createInputsOrientedLink = (
	...
	// 	[], '', true, '', undefined);
	const newFieldLabelLink: InputSelectableClass = new InputSelectableClass(id.toString() + 'labelLink',
	...
	const newFieldIsIncurved: InputSelectableClass = new InputSelectableClass(id.toString() + 'isIncurved',
		'Incurved', 'isIncurved' + id.toString(), 'select',
		[
			{ label: 'Yes', value: true },
			{ label: 'No', value: false },
		], '', true, 'Incurved', undefined);
	const newFieldPointCPositionX: InputSelectableClass = new InputSelectableClass(id.toString() + 'pointCX',
		'Point C - X', 'pointCX' + id.toString(), 'text',
		[], '', true, 'PointC-X', undefined);
	const newFieldPointCPositionY: InputSelectableClass = new InputSelectableClass(id.toString() + 'pointCY',
		'Point C - Y', 'pointCY' + id.toString(), 'text',
		[], '', true, 'PointC-Y', undefined);
	const newFieldButton: InputSelectableClass = new InputSelectableClass(id.toString() + 'deleteLink',
