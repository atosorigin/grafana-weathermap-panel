...
import { testEspaceCoordonnees } from 'EspaceCoordonnees';
//import { applyPanelTimeOverrides, calculateInnerPanelHeight } from 'EspaceCoordonnees/EspaceCoordonnees';
...
describe('testEspaceCoordonnees', () => {
  const text = 'hello';
